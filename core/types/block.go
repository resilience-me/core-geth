...
type Header struct {
	...
	Bloom       Bloom          // Bloom
	Skipped     *big.Int       // Total validators skipped since genesis
	Random      *big.Int       // Random number generated by validators
	Number      *big.Int       // The block number
	GasLimit    *big.Int       // Gas limit
	GasUsed     *big.Int       // Gas used
	Time        uint64         // Creation time
	Signature   []byte         // Validator header signature
}
...
func copyHeader(h *Header) *Header {
	cpy := *h
	if cpy.Skipped = new(big.Int); h.Skipped != nil {
		cpy.Skipped.Set(h.Skipped)
	}
	if cpy.Number = new(big.Int); h.Number != nil {
		cpy.Number.Set(h.Number)
	}
	if cpy.Random = new(big.Int); h.Random != nil {
		cpy.Random.Set(h.Random)
	}
...
func (b *Block) Skipped() *big.Int    { return new(big.Int).Set(b.header.Skipped) }
func (b *Block) Random() *big.Int     { return new(big.Int).Set(b.header.Random) }
...
[
	...
	Time:		    %v
	Signature:	    %s
]`, h.Hash(), h.ParentHash, h.UncleHash, h.Root, h.TxHash, h.ReceiptHash, h.Bloom, h.Skipped, h.Random, h.Number, h.GasLimit, h.GasUsed, h.Time, h.Signature)
}
